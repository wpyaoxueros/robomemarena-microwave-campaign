...
export ENDPOSE_HOLD_RELEASE_MIN_STEPS_BY_SUBTASK_FILE=${ENDPOSE_HOLD_RELEASE_MIN_STEPS_BY_SUBTASK_FILE:-${PACK_DIR}/config/task23_24_eef_runtime_pickplace_hold30_20260718.json}
...
export SUBTASK_RELEASE_ANCHORS_JSON=${SUBTASK_RELEASE_ANCHORS_JSON:-${PACK_DIR}/config/release_anchors_task23_v145_remove_cream_place_anchor.json}

case "${TASK_ID}" in
  20)
    export ENDPOSE_HOLD_POS_TOL_BY_SUBTASK_FILE=${ENDPOSE_HOLD_POS_TOL_BY_SUBTASK_FILE:-${PACK_DIR}/config/task23_eef_open105_pick060_place060_tol_20260718.json}
    ;;
  21)
