...
export EVAL_PY_OVERRIDE="${VERSION_DIR}/runtime/eval_tasks2_26_task22_stageprompt_openpickcookies_robotanchors_diagnostic.py"
...
export PORT="${PORT:-19431}"
export RUN_ID="${RUN_ID:-task22_v21_35999_stageprompt_openpickcookies_robotanchors_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export TASK22_V21_PACK_DIR_OVERRIDE="${PACK_DIR}"
exec bash "${VERSION_DIR}/runtime/launch_one_sync_hold_orig35999_v21.sh" 22
