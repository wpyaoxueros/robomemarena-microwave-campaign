...
export PORT="${PORT:-19426}"
export RUN_ID="${RUN_ID:-task22_v16_35999_builtin_norm_eef_softforward_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export REQUIRE_HOLD_RELEASE_FOR_FORWARD_SUBTASKS="pick tomato,pour first,pour second,place tomato aside,open microwave,pick cookies,place cookies"
...
export ENDPOSE_HOLD_CONSECUTIVE_BY_SUBTASK_JSON='{"pick tomato": 2, "pour first": 2, "pour second": 2, "place tomato aside": 2, "open microwave": 2, "pick cookies": 2, "place cookies": 2}'
