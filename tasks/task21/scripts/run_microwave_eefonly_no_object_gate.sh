...
export ENDPOSE_HOLD_RELEASE_MIN_STEPS_BY_SUBTASK_FILE=${ENDPOSE_HOLD_RELEASE_MIN_STEPS_BY_SUBTASK_FILE:-${RUNTIME_PACK_DIR}/config/task21_eef_runtime_pickplace_hold30_20260718.json}
...
export SUBTASK_RELEASE_ANCHORS_JSON=${SUBTASK_RELEASE_ANCHORS_JSON:-${RUNTIME_PACK_DIR}/config/release_anchors_t21_t23_openpick_robotonly.json}
