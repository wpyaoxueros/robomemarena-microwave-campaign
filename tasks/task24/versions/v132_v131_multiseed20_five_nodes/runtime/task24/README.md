...
This directory contains only the local Task24 v131 evaluation chain. Runtime model, dataset, and remote RoboMemArena locations are supplied through the private `inputs.env` interface at the package root.
...
Official scoring is pinned to commit `62214036103ee8d5fef9b475dd8b344b6e2cfc03`. The launcher exports `ROBOMEMARENA_OFFICIAL_SCRIPTS_DIR` and requires
