...
FROZEN_EVALUATOR="${FROZEN_CODE}/eval_tasks2_26_sync_endpose_hold_officialscore.py"
FROZEN_BASE_EVALUATOR="${FROZEN_REPRO}/base_eval_py__eval_tasks2_26_vlm_vla.py"
