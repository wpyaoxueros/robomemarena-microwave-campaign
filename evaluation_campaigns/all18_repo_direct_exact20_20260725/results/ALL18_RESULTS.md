...
| 2 | archived special package | 0/20 | - | original frozen Task2 route | running, fresh 20ep | `/data/user/xiangqim/hlei573_borrow_outputs/all18_repo_direct_exact20_20260725/task2/task2_all18_frozen20_single_gpu_20260725_061059/` |
...
| 7 | Task7 counting package | 0/20 | - | d9f83ac | pending source-overlay batch | `runs/COUNTING_DIRECT20_OVERLAYFIX_20260725.md` |
| 10 | Task10 counting package | 0/20 | - | d9f83ac | pending source-overlay batch | `runs/COUNTING_DIRECT20_OVERLAYFIX_20260725.md` |
...
| 16 | Task16 counting package | 0/20 | - | d9f83ac | pending source-overlay batch | `runs/COUNTING_DIRECT20_OVERLAYFIX_20260725.md` |
