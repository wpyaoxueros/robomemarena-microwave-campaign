...
# v124 differs from v123 only by restoring the historical robot-only
# pick-cookies -> place-cookies reset after VLM has supplied that next prompt.
...
export SUBTASK_RELEASE_ANCHORS_JSON=${PACK_DIR}/config/release_anchors_t24_add_pick2place_robotonly_20260722.json
