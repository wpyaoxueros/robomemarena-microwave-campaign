...
export EVAL_PY_OVERRIDE="${VERSION_DIR}/runtime/eval_tasks2_26_task22_stageprompt_openrobotanchor_sparse_rawvlm_diagnostic.py"
...
export PORT="${PORT:-19434}"
export RUN_ID="${RUN_ID:-task22_v25_35999_v20_placecookies_start0_robotonly_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export TASK22_STAGEPROMPT_RAW_VLM_INTERVAL=50
export INITIAL_SUBTASK_ANCHORS_JSON="${VERSION_DIR}/task22_initial_open_pickcookies_placecookies_start0_robotonly_seed104.json"
...
export TASK22_V20_PACK_DIR_OVERRIDE="${PACK_DIR}"
exec bash "${VERSION_DIR}/runtime/launch_one_sync_hold_orig35999_v20.sh" 22
