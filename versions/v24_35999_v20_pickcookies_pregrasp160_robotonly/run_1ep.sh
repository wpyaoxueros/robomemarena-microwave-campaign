...
export RUN_ID="${RUN_ID:-task22_v24_35999_v20_pickcookies_pregrasp160_robotonly_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export INITIAL_SUBTASK_ANCHORS_JSON="${VERSION_DIR}/task22_initial_open_pickcookies_pregrasp160_robotonly_seed104.json"
