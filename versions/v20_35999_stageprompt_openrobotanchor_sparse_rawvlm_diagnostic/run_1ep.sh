...
export PORT="${PORT:-19430}"
export RUN_ID="${RUN_ID:-task22_v20_35999_stageprompt_openrobotanchor_sparse_rawvlm_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export INITIAL_SUBTASK_ANCHORS_JSON="${VERSION_DIR}/task22_initial_open_robotonly_seed104.json"
...
"${VERSION_DIR}/verify_open_robot_anchor.sh" "${INITIAL_SUBTASK_ANCHORS_JSON}"
