...
export EVAL_PY_OVERRIDE="${VERSION_DIR}/runtime/eval_tasks2_26_task22_stageprompt_openpickcookies_robotanchors_vlm150_diagnostic.py"
...
export PORT="${PORT:-19432}"
export RUN_ID="${RUN_ID:-task22_v22_35999_stageprompt_openpickcookies_robotanchors_vlm150_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export TASK22_STAGEPROMPT_RAW_VLM_INTERVAL=150
export INITIAL_SUBTASK_ANCHORS_JSON="${VERSION_DIR}/task22_initial_open_pickcookies_robotonly_seed104.json"
...
"${VERSION_DIR}/verify_robot_anchors.sh" "${INITIAL_SUBTASK_ANCHORS_JSON}"
export TASK22_V22_PACK_DIR_OVERRIDE="${PACK_DIR}"
exec bash "${VERSION_DIR}/runtime/launch_one_sync_hold_orig35999_v22.sh" 22
