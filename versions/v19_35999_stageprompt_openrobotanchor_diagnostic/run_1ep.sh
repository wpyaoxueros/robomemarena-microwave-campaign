...
export EVAL_PY_OVERRIDE="${VERSION_DIR}/runtime/eval_tasks2_26_task22_stageprompt_openrobotanchor_diagnostic.py"
...
export PORT="${PORT:-19429}"
export RUN_ID="${RUN_ID:-task22_v19_35999_stageprompt_openrobotanchor_seed104_$(date +%Y%m%d_%H%M%S)}"
...
export TASK22_V19_PACK_DIR_OVERRIDE="${PACK_DIR}"
exec bash "${VERSION_DIR}/runtime/launch_one_sync_hold_orig35999_v19.sh" 22
