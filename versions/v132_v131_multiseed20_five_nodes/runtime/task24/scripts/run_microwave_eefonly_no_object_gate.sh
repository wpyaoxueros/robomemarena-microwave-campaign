...
export ENDPOSE_HOLD_RELEASE_MIN_STEPS_BY_SUBTASK_FILE=${ENDPOSE_HOLD_RELEASE_MIN_STEPS_BY_SUBTASK_FILE:-${PACK_DIR}/config/task20_eef_runtime_place_hold30.json}
...
export SUBTASK_RELEASE_ANCHORS_JSON=${SUBTASK_RELEASE_ANCHORS_JSON:-${PACK_DIR}/config/release_anchors_t20_t21_t23_t24_robotonly.json}

case "${TASK_ID}" in
  20)
    export ENDPOSE_HOLD_POS_TOL_BY_SUBTASK_FILE=${ENDPOSE_HOLD_POS_TOL_BY_SUBTASK_FILE:-${PACK_DIR}/config/task20_eef_runtime_place_tol14_24.json}
    ;;
  21)
