...
_base_eval_raw = os.environ.get("TASKS2_26_BASE_EVAL_PY", "").strip()
if not _base_eval_raw:
    raise RuntimeError("TASKS2_26_BASE_EVAL_PY must point to the pinned RoboMemArena base evaluator")
BASE_EVAL_PY = Path(_base_eval_raw)
...
DEFAULT_TARGET_JSON = str(PORTABLE_CONFIG_DIR / "task14_eef_targets.json")
LEGACY_TARGET_PASSAGE_COUNTS_JSON = ""
DEFAULT_TARGET_PASSAGE_COUNTS_JSON = str(PORTABLE_CONFIG_DIR / "task14_passage_counts.json")
