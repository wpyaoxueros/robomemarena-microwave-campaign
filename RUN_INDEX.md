...
| 22 | v3_native_pour_boundary_upweight | `robomemarena-task22-autonomous-repro` | `62bb4fe` | data build then VLM retrain | data build accepted: 326,500 base rows plus 44,400 native `pour_first` boundary copies; source/output hashes recorded; no runtime behavior change |
