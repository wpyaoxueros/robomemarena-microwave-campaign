...
| 22 | v3_native_pour_boundary_upweight | `robomemarena-task22-autonomous-repro` | `1ae0d4c` | batch probe then 500-step VLM finetune | data build accepted: 326,500 base rows plus 44,400 native `pour_first` boundary copies; source/output hashes recorded; no runtime behavior change |
