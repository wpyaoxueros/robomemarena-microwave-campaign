...
| 22 | v2_vlm_eef_pour_forwardguard | `robomemarena-task22-autonomous-repro` | `0371e09` | 104 smoke | planned: VLM-owned prompt transitions with EEF-only forward timing for pick tomato and pour first; no stage-prompt override or object anchor |
