...
| 22 | v3_native_pour_boundary_upweight | `robomemarena-task22-autonomous-repro` | `e77eb47` | data build then VLM retrain | planned: preserve original JSONL byte-for-byte and append only canonical native `pour_first` start-window copies; no runtime behavior change |
